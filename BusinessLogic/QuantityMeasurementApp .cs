...
public class QuantityMeasurementApp
{
    ...
    {
        QuantityLength quantityLength = new QuantityLength();
        // quantityLength.HandleFeetEquality();
        // quantityLength.HandleInchEquality();
        // quantityLength.HandleGenericLengthEquality();
        // quantityLength.HandleConversionUnitFromSrcToBaseTarget();
